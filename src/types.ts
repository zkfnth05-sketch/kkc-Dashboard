...
export interface ProClass { uid: string; keyy: string; name: string; type?: number; }
...
export interface Point {
  ...
  award: string;
  regDate: string;
  eventDate?: string; // pt_event_date
  judge?: string;     // pt_judge
}
...
export interface ParentDogInfo { uid: string; name: string; fullname: string; reg_no: string; birth: string; dog_class: string; hair: string; hair_long: string; saho_eng: string; foreign100: string; foreign_no: string; foreign_no2: string; fa_regno?: string; mo_regno?: string; spec_bone?: string; spec_dna?: string; spec_train?: string; spec_win?: string; spec_win2?: string; sex?: string; gender?: string; spec_male?: string; }
