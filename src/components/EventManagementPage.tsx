                                    ...
                                    <div className="space-y-1.5">
                                        {dayEvs.map(e => (
                                            <div
                                                ...
                                                className="text-[9.5px] md:text-[11.5px] font-black p-1 md:p-2 rounded-md md:rounded-lg bg-white border border-slate-100 shadow-sm flex items-center gap-1 md:gap-2 truncate hover:bg-slate-50 transition-colors cursor-pointer"
                                                title={e.title}
                                            >
