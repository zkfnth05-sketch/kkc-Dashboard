...
export const niceAdminPedigreeAction = (uid: number, action: 'approve' | 'reject', memo: string, hair?: string, breed_name?: string, reg_no?: string) =>
  portalFetchNice('admin_nice_pedigree_action', { uid, action, memo, hair, breed_name, reg_no });
